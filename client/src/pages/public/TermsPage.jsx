...
export default function TermsPage() {
  return (
    <DocPage
      ...
      intro="The rules for using DevCrunch. By creating an account or using the platform, you agree to these terms."
      updated="June 2026"
    >
      <h2>1. Accepting these terms</h2>
      <p>
        These Terms of Service (&quot;Terms&quot;) govern your access to and use of
        DevCrunch (the &quot;Service&quot;). By accessing, browsing, or using the
      ...
      <p>
        You retain ownership of everything you write and publish on DevCrunch. By
      ...
      <p>You agree not to use DevCrunch to:</p>
      <ul>
      ...
      <p>
        ...
        the maximum extent permitted by law, DevCrunch is not liable for indirect,
